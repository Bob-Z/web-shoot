...
gcc -o web-shoot main.c debug.c network.c opengl.c background.c yandex.c misc.c image_fifo.c loader.c test_engine.c file_engine.c wikimedia_engine.c deviantart_engine.c -g -O0 -Wall $CFLAGS $LIBS -lSDL_image -lcurl -lpthread -lreadline -lGL -lm
